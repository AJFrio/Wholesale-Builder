// Centralized CSS classes for consistent styling across components with blue and glassmorphic style

export const INPUT_CLASSES = {
  // Standard text/number inputs with glass effect
  base: "w-full bg-white bg-opacity-20 backdrop-blur-lg border border-blue-300 rounded-lg px-3 py-2 text-blue-900 focus:outline-none focus:ring-2 focus:ring-blue-800 focus:border-blue-800",
  
  // Small inputs (like quantity in attachments)
  small: "w-16 bg-white bg-opacity-20 backdrop-blur-lg border border-blue-300 rounded px-2 py-1 text-blue-900 text-sm focus:outline-none focus:ring-1 focus:ring-blue-800 focus:border-blue-800 placeholder-blue-400"
}

export const SELECT_CLASSES = {
  // Standard dropdown selects with glass effect
  base: "w-full bg-white bg-opacity-20 backdrop-blur-lg border border-blue-300 rounded-lg px-3 py-2 text-blue-900 focus:outline-none focus:ring-2 focus:ring-blue-800 focus:border-blue-800",
  
  // Large selects (like country selector) with glass effect
  large: "w-full bg-white bg-opacity-20 backdrop-blur-lg border border-blue-300 rounded-lg px-4 py-2 text-blue-900 focus:outline-none focus:ring-2 focus:ring-blue-800 focus:border-blue-800"
}
...
export const CONTAINER_CLASSES = {
  ...
  card: "bg-white bg-opacity-20 backdrop-blur-lg rounded-lg p-6 shadow-lg border border-white/30",
  
  // Sub-container (like attachment items) with glass effect
  subCard: "bg-white bg-opacity-20 backdrop-blur-lg rounded-lg p-4 border border-white/30",
  
  // Small item containers (like breakdown items) with glass effect
  item: "bg-white bg-opacity-20 backdrop-blur-lg rounded p-3 text-sm border border-white/30",
  
  // Toggle button container with glass effect
  toggleContainer: "flex bg-white bg-opacity-20 backdrop-blur-lg rounded-lg p-1 border border-white/30"
}
